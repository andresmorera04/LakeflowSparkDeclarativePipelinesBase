...
try:
    ...
    # _ruta_notebook ejemplo: /Repos/user/RepoName/tests/GenerarParquets/NbTestMaestroCliente
    # Subimos 2 niveles desde tests/GenerarParquets/ hasta la raiz del repo
    _partes = _ruta_notebook.split("/")
    _raiz_repo = "/".join(_partes[:-2])  # quita tests/GenerarParquets
...
ruta_notebook_generador = os.path.join(
    _raiz_workspace, "scripts", "GenerarParquets", "NbGenerarMaestroCliente.py"
)
...
# MAGIC %md
# MAGIC ## T019 — Validacion de Compatibilidad Serverless (V2-R5-D1, RV-22, RV-24)
# MAGIC
...
# Reutilizar _raiz_workspace y ruta_notebook_generador definidos en la celda de auditoria
...
# MAGIC %md
# MAGIC ## T019 — Validacion de Protocolo abfss:// en Widgets (V2-R5-D2, RV-23)
# MAGIC
